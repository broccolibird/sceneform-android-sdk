...
public final class ParameterInitDefType
{
    ...
    public static String name(final int e) {
        return ParameterInitDefType.names[e];
    }
    
    static {
        names = new String[] { "NONE", "NullInit", "ScalarInit", "Vec3Init", "Vec4Init", "SamplerInit", "Vec2Init", "BoolInit", "BoolVec2Init", "BoolVec3Init", "BoolVec4Init", "IntInit", "IntVec2Init", "IntVec3Init", "IntVec4Init", "CubemapSamplerInit", "ExternalSamplerInit", "DoubleInit", "DoubleVec2Init", "DoubleVec3Init", "DoubleVec4Init" };
    }
}
