...
import pro.streem.ar.sceneform.ArSceneView;
import pro.streem.ar.sceneform.FrameTime;
import pro.streem.ar.sceneform.HitTestResult;
import pro.streem.ar.sceneform.Scene;
import pro.streem.ar.sceneform.rendering.ModelRenderable;
...
public abstract class BaseArFragment extends Fragment
    ...
    public interface OnTapArPlaneListener {
         ...
         * pro.streem.ar.sceneform.Node} was tapped.
         *
     ...
     * invoked if no {@link pro.streem.ar.sceneform.Node} was tapped.
     *
