...
{
    public static ExternalSamplerInit getRootAsExternalSamplerInit(final ByteBuffer _bb) {
        return getRootAsExternalSamplerInit(_bb, new ExternalSamplerInit());
    }
    
    public static ExternalSamplerInit getRootAsExternalSamplerInit(final ByteBuffer _bb, final ExternalSamplerInit obj) {
    ...
    public ExternalSamplerInit __assign(final int _i, final ByteBuffer _bb) {
        this.__init(_i, _bb);
        return this;
    }
    ...
    public static int createExternalSamplerInit(final FlatBufferBuilder builder, final int pathOffset, final int usage) {
    ...
    public static void startExternalSamplerInit(final FlatBufferBuilder builder) {
        builder.startObject(2);
    }
    ...
    public static int endExternalSamplerInit(final FlatBufferBuilder builder) {
